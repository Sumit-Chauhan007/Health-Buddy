...
<div class="content-wrapper">
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span> Add New ABC Blog</h4>
    <!-- Basic Layout -->
    <div class="row">
      <div class="col-xl">
        <div class="card mb-4">
              ...
              <div class="row">
                <div class="mb-3 col-xl-6 col-xs-12">
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      ></span>
                      <input type="text" name="heading1" id="heading1" placeholder="Enter Your first Heading" class="form-control input form-control-line" minlength="3" maxlength="30" >
                    </div>
                  </div>
                  <div class="mb-3 col-xl-6 col-xs-12">
                    ...
                    <div class="input-group input-group-merge">
                      <span id="basic-icon-default-fullname2" class="input-group-text"
                        ><i class="bx bx-user"></i
                      ></span>
                      <textarea class="form-control input form-control-line"  name="description1" id="description1" cols="30" rows="4"></textarea>
                    </div>
                  </div>
              </div>
              <div class="row">
                <div class="mb-3 col-xl-6 col-xs-12">
                    ...
                    <div class="input-group input-group-merge">
                      <span id="basic-icon-default-fullname2" class="input-group-text"
                        ><i class="bx bx-user"></i
                      ></span>
                      <input type="text" name="heading2" id="heading2" placeholder="Enter Your Second Heading" class="form-control input form-control-line" minlength="3" maxlength="30" >
                    </div>
                  </div>
                  <div class="mb-3 col-xl-6 col-xs-12">
                    ...
                    <div class="input-group input-group-merge">
                      <span id="basic-icon-default-fullname2" class="input-group-text"
                        ><i class="bx bx-user"></i
                      ></span>
                      <textarea class="form-control input form-control-line"  name="description2" id="description2" cols="30" rows="4"></textarea>
                    </div>
                  </div>
              </div>
              <div class="row">
                <div class="mb-3 col-xl-6 col-xs-12">
                    ...
                    <div class="input-group input-group-merge">
                      <span id="basic-icon-default-fullname2" class="input-group-text"
                        ><i class="bx bx-user"></i
                      ></span>
                      <input type="text" name="heading3" id="heading3" placeholder="Enter Your Third Heading" class="form-control input form-control-line" minlength="3" maxlength="30" >
                    </div>
                  </div>
                  <div class="mb-3 col-xl-6 col-xs-12">
                    ...
                    <div class="input-group input-group-merge">
                      <span id="basic-icon-default-fullname2" class="input-group-text"
                        ><i class="bx bx-user"></i
                      ></span>
                      <textarea class="form-control input form-control-line"  name="description3" id="description3" cols="30" rows="4"></textarea>
                    </div>
                  </div>
              </div>
