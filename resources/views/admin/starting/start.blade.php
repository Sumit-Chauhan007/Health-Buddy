...
<div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y row">
        <div class="col-6"><h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Blogs /</span>Starting BLog Detail</h4></div>
        <div class="col-6">
            <div class="text-end upgrade-btn">
                <a href="add-blog" class="btn btn-primary text-white">Add New Blog</a>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-6">
                    <img src="assets/images/starting/{{$blog->image}}" alt="">
                </div>
                <div class="col-6">
                    <h1>{{$blog->heading}}</h1>
