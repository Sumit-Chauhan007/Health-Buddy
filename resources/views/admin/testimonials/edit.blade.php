...
<div class="content-wrapper">
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span> Edit New Testimonial </h4>
    <!-- Basic Layout -->
    <div class="row">
      <div class="col-xl">
        <div class="card mb-4">
            ...
            <form method="POST" action="{{ url('/add-new-testimonial') }}" enctype="multipart/form-data">
              <div class="mb-3">
                ...
                <div class="input-group input-group-merge">
                  ...
                  ></span>
                  <input type="text" name="Name" id="Name" value="{{$testimonial->name}}" placeholder="Enter Your Name" class="form-control input form-control-line" minlength="3" maxlength="30" >
                </div>
              </div>
              <div class="mb-3">
                ...
                <div class="input-group input-group-merge">
                  <span id="basic-icon-default-fullname2" class="input-group-text"
                    ><i class="bx bx-user"></i
                  ></span>
                  <input type="text" name="Designation" value="{{$testimonial->designation}}" id="Designation" placeholder="Enter Designation" class="form-control input form-control-line" minlength="3" maxlength="30" >
                </div>
              </div>
              <div class="mb-3">
                ...
                <div class="input-group input-group-merge">
                  <span id="basic-icon-default-fullname2" class="input-group-text"
                    ><i class="bx bx-user"></i
                  ></span>
                  <textarea class="form-control input form-control-line"  name="description" id="description" cols="30" rows="4">{{$testimonial->description}}</textarea>
                </div>
              </div>
              <div class="mb-3">
              ...
              <button type="button" onclick="getuser('{{$testimonial->uuid}}')" class="btn btn-success text-white">Save</button>
            </form>
          </div>
        </div>
      </div>
