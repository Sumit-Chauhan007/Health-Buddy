...
<div class="content-wrapper">
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span> Add New Team Blog</h4>
    <!-- Basic Layout -->
    <div class="row">
      <div class="col-xl">
        <div class="card mb-4">
              ...
              <div class="row">
                <div class="mb-3 col-xl-6 col-xs-12">
                    ...
                    <div class="input-group input-group-merge">
                      ...
                      ></span>
                      <input type="text" name="name" id="name" placeholder="Enter name" class="form-control input form-control-line" minlength="3" maxlength="30" onkeydown="return /[a-zA-Z\s]/i.test(event.key)">
                    </div>
                  </div>
                  <div class="mb-3 col-xl-6 col-xs-12">
                    ...
                    <div class="input-group input-group-merge">
                      <span id="basic-icon-default-fullname2" class="input-group-text"
                        ><i class="bx bx-user"></i
                      ></span>
                      <input type="text" name="designation" id="designation" placeholder="Enter Designation" class="form-control input form-control-line" minlength="3" maxlength="30" onkeydown="return /[a-zA-Z\s]/i.test(event.key)">
                    </div>
                  </div>
              </div>
              <div class="mb-3">
