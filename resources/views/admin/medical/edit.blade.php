...
<div class="content-wrapper">
  ...
  <div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light"></span> Edit New Medical Blog</h4>
    <!-- Basic Layout -->
    <div class="row">
      <div class="col-xl">
        <div class="card mb-4">
            ...
            <form method="POST" action="{{ url('add-new-starting-blog') }}" enctype="multipart/form-data">
              <div class="mb-3">
                ...
                <div class="input-group input-group-merge">
                  ...
                  ></span>
                  <input type="text" name="heading" value="{{$MedicalBlogs->heading}}" id="heading" placeholder="Enter Your Heading" class="form-control input form-control-line" minlength="3" maxlength="30" >
                </div>
              </div>
              <div class="mb-3">
                ...
                <div class="input-group input-group-merge">
                  <span id="basic-icon-default-fullname2" class="input-group-text"
                    ><i class="bx bx-user"></i
                  ></span>
                  <textarea class="form-control input form-control-line"  name="description" id="description" cols="30" rows="4">{{$MedicalBlogs->description}} </textarea>
                </div>
              </div>
              <div class="mb-3">
                <label class="form-label" for="basic-icon-default-image">Background Image</label>
                <div class="input-group input-group-merge">
              ...
              <button type="button" onclick="getuser('{{$MedicalBlogs->blog_uuid}}')" class="btn btn-success text-white">Save</button>
            </form>
          </div>
        </div>
      </div>
