...
<head>
    ...
    <script class="u-script" type="text/javascript" src="homestyle.js" defer=""></script>
    <meta name="referrer" content="origin">
    <link id="u-theme-google-font" rel="stylesheet"
        href="https://fonts.googleapis.com/css?family=Roboto:100,100i,300,300i,400,400i,500,500i,700,700i,900,900i|Open+Sans:300,300i,400,400i,500,500i,600,600i,700,700i,800,800i">
    <link id="u-page-google-font" rel="stylesheet"
        href="https://fonts.googleapis.com/css?family=Oswald:200,300,400,500,600,700|Oswald:200,300,400,500,600,700">
...
<body class="u-body u-xl-mode" data-lang="en">
    <header class="u-clearfix u-header u-header" id="sec-e0e9" style="background-color: #ffebec">
        <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
            <a href="/" class="u-image u-logo u-image-1">
                <img src="/logo1.png" class="u-logo-image u-logo-image-1">
            </a>
            <nav class="u-menu u-menu-hamburger u-offcanvas u-menu-1" data-responsive-from="XL">
                <ul class="u-nav u-spacing-2 u-unstyled u-nav-1" id="DocNavbarList" style="margin-top:-20px ">
                    ...
                    <li class="u-nav-item"><a
                            class="u-active-grey-5 u-button-style u-hover-grey-10 u-nav-link u-text-active-grey-90 u-text-grey-90 u-text-hover-grey-90"
                            href="#sec-9758" style="padding: 10px 20px;">Services</a>
                    </li>
                    <li class="u-nav-item"><a
                            class="u-active-grey-5 u-button-style u-hover-grey-10 u-nav-link u-text-active-grey-90 u-text-grey-90 u-text-hover-grey-90"
                            href="#carousel_8027" style="padding: 10px 20px;">Team</a>
                    </li>
                    <li class="u-nav-item"><a
                            class="u-active-grey-5 u-button-style u-hover-grey-10 u-nav-link u-text-active-grey-90 u-text-grey-90 u-text-hover-grey-90"
                            href="#letscomehere" style="padding: 10px 20px;">Contact Us</a>
                    </li>
                </ul>
                <div class="menu-collapse" id="openNavbarOption" style="font-size: 1rem; letter-spacing: 0px; font-weight: 500;">
                    ...
                    <div class="u-black u-container-style u-inner-container-layout u-opacity u-opacity-95 u-sidenav">
                        <div class="u-inner-container-layout u-sidenav-overflow">
                            ...
                            <ul class="u-align-center u-nav u-popupmenu-items u-unstyled u-nav-2">
                                ...
                                <li class="u-nav-item"><a class="u-button-style u-nav-link" href="#sec-9758"
                                        style="padding: 10px 20px;">Services</a>
                                </li>
                                <li class="u-nav-item"><a class="u-button-style u-nav-link" href="#carousel_8027"
                                        style="padding: 10px 20px;">Team</a>
                                </li>
                                <li class="u-nav-item"><a class="u-button-style u-nav-link" href="#letscomehere"
            ...
            <div class="u-clearfix u-layout-wrap u-layout-wrap-1">
                <div class="u-layout">
                    <div class="u-layout-row">
                        <div
                            class="u-align-center u-container-style u-image u-layout-cell u-left-cell u-size-30 u-image-1">
                            <div class="u-container-layout u-valign-bottom u-container-layout-1"
                                style="background-image: url('assets/images/starting/{{ $Starting->image }}')"></div>
                        </div>
                        <div
                            class="u-align-left u-container-style u-layout-cell u-right-cell u-size-30 u-layout-cell-2">
                            <div class="u-container-layout u-valign-middle u-container-layout-2">
                                <h5 class="u-text u-text-1" data-animation-name="fadeIn"
                                    data-animation-duration="1000" data-animation-direction="Down"><b>YOUR HEALTH
                                        BUDDY</b>
                                </h5>
                                <h1 class="u-custom-font u-font-oswald u-text u-text-palette-1-base u-text-2"
                                    data-animation-name="fadeIn" data-animation-duration="1000"
                                    data-animation-direction="Down">{{ $Starting->heading }}</h1>
                                <p class="u-text u-text-palette-5-dark-2 u-text-3" data-animation-name="fadeIn"
                                    data-animation-duration="1000" data-animation-direction="Down"
                                    data-animation-delay="250">{{ $Starting->description }}<br>
                                </p>
                                <a href="#letscomehere"
                                    class="u-active-palette-1-base u-align-center u-border-2 u-border-active-palette-1-base u-border-hover-palette-1-base u-border-palette-1-base u-btn u-btn-round u-button-style u-hover-palette-1-base u-none u-radius-8 u-text-active-white u-text-hover-white u-btn-2"
                                    data-animation-name="fadeIn" data-animation-duration="1000"
                                    data-animation-direction="Up" data-animation-delay="500">Contact us</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="u-repeater u-repeater-1">
                    ...
                    <div class="u-container-style u-list-item u-palette-1-base u-repeater-item u-list-item-1">
                        <div class="u-container-layout u-similar-container u-container-layout-5"><span
                                class="u-icon u-icon-circle u-text-palette-1-base u-white u-icon-2"
                                data-animation-name="rollIn" data-animation-duration="1000"
                                data-animation-direction=""><svg class="u-svg-link"
                                    preserveAspectRatio="xMidYMin slice" viewBox="0 0 480.007 480.007"
                                    style="">
                                    <use xlink:href="#svg-d648"></use>
                                </svg><svg class="u-svg-content" viewBox="0 0 480.007 480.007" x="0px"
                                    y="0px" id="svg-d648" style="enable-background:new 0 0 480.007 480.007;">
                                    <g>
                                        <g>
                                            <path
                            ...
                            <div class="u-container-style u-group u-group-2">
                                <div class="u-container-layout u-valign-top u-container-layout-6">
                                    <h4 class="u-text u-text-default u-text-7">{{ $first->heading2 }}</h4>
                                    <p class="u-text u-text-8">{{ $first->description2 }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    @if ($MedicalBlogs->count() > 0)
        <section class="u-align-center u-clearfix u-section-2" id="sec-9758">
            <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
                ...
                <div class="u-expanded-width u-list u-list-1">
                    <div class="u-repeater u-repeater-1">
                        @foreach ($MedicalBlogs as $Medical)
                            <div class="u-container-style u-list-item u-repeater-item">
                                <div
                                    ...
                                    <img alt=""
                                        ...
                                        data-image-width="500" data-image-height="357"
                                        src="assets/images/Medical/{{ $Medical->image }}">
                                    <div
                                        class="u-container-style u-expanded-width-sm u-expanded-width-xs u-group u-group-1">
                                        <div class="u-container-layout u-valign-top u-container-layout-2">
                                            <h4 class="u-text u-text-3"> {{ $Medical->heading }}</h4>
                                            <p class="u-text u-text-4">{{ $Medical->description }}</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    @endif
    <section class="u-clearfix u-palette-1-base u-section-3" id="carousel_361c">
        <div class="u-expanded-width u-grey-5 u-shape u-shape-rectangle u-shape-1"></div>
        <div class="u-clearfix u-layout-wrap u-layout-wrap-1">
            <div class="u-gutter-0 u-layout">
                <div class="u-layout-col">
                    <div class="u-container-style u-image u-layout-cell u-size-30 u-image-1" data-image-width="1100"
                ...
                <div class="row">
                    <div class="u-container-style u-layout-cell u-size-30 u-layout-cell-3">
                        <div class="u-container-layout u-valign-top u-container-layout-3">
                            <p class="u-text u-text-2"> Its departments are equipped with state-of-the-art diagnostic
                                and therapeutic equipment and operated by top-category physicians, Ph.D. and Doctors of
                                Medicine, associate professors and professors knowledgeable of the best available
                                practices of European schools. Partnerships with specialized clinics and research
                                centers in Russia and Europe make possible consultations by doctors of unique
                                specialties.<br>
                            </p>
                        </div>
                    </div>
                    {{-- <div class="u-container-style u-layout-cell u-size-34 u-layout-cell-4">
                        <div class="u-container-layout u-container-layout-4">
                            ...
                            <a href="https://nicepage.com/wordpress-website-builder"
                                class="u-active-white u-align-center u-border-2 u-border-active-white u-border-hover-white u-border-white u-btn u-btn-round u-button-style u-hover-white u-none u-radius-8 u-btn-2">Contact
                                us</a>
                        </div>
                    </div> --}}
                </div>
    ...
    <section class="u-clearfix u-section-4" id="carousel_8486">
            ...
            <div class="u-repeater u-repeater-1">
                <div class="u-align-center u-container-style u-list-item u-repeater-item u-white u-list-item-1">
                    <div class="u-container-layout u-similar-container u-container-layout-1">
                        ...
                        <h3 class="u-text u-text-palette-1-base u-text-2">{{ $AbcBlog->heading2 }}</h3>
                        <p class="u-text u-text-3"> {{ $AbcBlog->description1 }}</p>
                    </div>
                </div>
                <div class="u-align-center u-container-style u-list-item u-repeater-item u-white u-list-item-2">
                    <div class="u-container-layout u-similar-container u-container-layout-2">
                        <h2 class="u-text u-text-default u-text-palette-1-base u-text-4">B</h2>
                        <h3 class="u-text u-text-palette-1-base u-text-5">{{ $AbcBlog->heading3 }}</h3>
                        <p class="u-text u-text-6"> {{ $AbcBlog->description2 }}</p>
                    </div>
                </div>
                <div class="u-align-center u-container-style u-list-item u-repeater-item u-white u-list-item-3">
                    <div class="u-container-layout u-similar-container u-container-layout-3">
                        <h2 class="u-text u-text-default u-text-palette-1-base u-text-7">C</h2>
                        <h3 class="u-text u-text-palette-1-base u-text-8">{{ $AbcBlog->heading1 }}</h3>
                        <p class="u-text u-text-9"> {{ $AbcBlog->description3 }}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    {{-- <section
        class="u-clearfix u-valign-middle-lg u-valign-middle-md u-valign-middle-sm u-valign-middle-xl u-white u-section-5"
        id="carousel_d07f">
        <div class="u-clearfix u-layout-wrap u-layout-wrap-1">
            <div class="u-layout">
                <div class="u-layout-row">
                    <div
                        ...
                        <div class="u-container-layout u-valign-middle u-container-layout-1">
                            ...
                            <p class="u-text u-text-2">Our Company has the experience and expertise to meet these
                            ...
                            <p class="u-text u-text-default u-text-3" data-animation-name="fadeIn"
                                data-animation-duration="1000" data-animation-direction=""
                                data-animation-delay="250">Image from <a href="https://billionphotos.com/"
                                    class="u-active-none u-border-1 u-border-active-black u-border-hover-black u-border-no-left u-border-no-right u-border-no-top u-border-palette-1-base u-btn u-button-link u-button-style u-hover-none u-none u-text-body-color u-btn-2">Billionphotos</a>
                            </p>
                        </div>
                    </div>
                    <div
    ...
    @if ($ContactUs)
        <section class="u-align-center u-clearfix u-gradient u-section-6" id="sec-94ff">
            <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
                <h2 class="u-text u-text-default u-text-palette-1-base u-text-1"> {{ $ContactUs->heading }}</h2>
                <div class="u-clearfix u-expanded-width u-layout-wrap u-layout-wrap-1">
                    <div class="u-layout">
                        <div class="u-layout-row">
                            <div class="u-container-style u-layout-cell u-left-cell u-size-20 u-layout-cell-1">
                                <div class="u-container-layout u-container-layout-1">
                                    <p class="u-text u-text-default u-text-2">{{ $ContactUs->description1 }}</p>
                                </div>
                            </div>
                            <div class="u-container-style u-layout-cell u-size-20 u-layout-cell-2">
                                <div class="u-container-layout u-container-layout-2">
                                    <p class="u-text u-text-default u-text-3">{{ $ContactUs->description2 }}</p>
                                </div>
                            </div>
                            <div class="u-container-style u-layout-cell u-right-cell u-size-20 u-layout-cell-3">
                                <div class="u-container-layout u-container-layout-3">
                                    <p class="u-text u-text-default u-text-4">{{ $ContactUs->description3 }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    @endif
    @if ($teams->count() > 0)
        <section class="u-align-center u-clearfix u-valign-middle u-section-7" id="carousel_8027">
                ...
                <div class="u-repeater u-repeater-1">
                    @foreach ($teams as $team)
                        <div class="u-align-center u-container-style u-grey-5 u-list-item u-repeater-item">
                            <div class="u-container-layout u-similar-container u-container-layout-1">
                                <div alt="" class="u-image u-image-circle u-image-1" data-image-width="420"
                                    data-image-height="420"
                                    style="background-image: url('assets/images/Team/{{ $team->image }}')"></div>
                                <h5 class="u-text u-text-default u-text-2">{{ $team->name }}</h5>
                                <h6 class="u-custom-font u-text u-text-default u-text-font u-text-3">
                                    {{ $team->designation }}
                                </h6>
                                <p class="u-text u-text-4">{{ $team->description }}</p>
                            </div>
                        </div>
                    @endforeach
                </div>
    ...
    @endif
    <section class="u-align-center u-clearfix u-gradient u-section-8" id="carousel_7db6">
        <div class="u-clearfix u-sheet u-valign-middle u-sheet-1">
            ...
            <div class="u-expanded-width u-list u-list-1">
                <div class="u-repeater u-repeater-1">
                    @foreach ($testimonials as $item)
                        <div
                            class="u-container-style u-list-item u-radius-7 u-repeater-item u-shape-round u-white u-list-item-1">
                            <div class="u-container-layout u-similar-container u-container-layout-1">
                                <div alt=""
                                    class="u-border-8 u-border-palette-1-light-3 u-image u-image-circle u-image-1"
                                    data-image-width="211" data-image-height="211"></div>
                                <p class="u-text u-text-2">{{ $item->description }} </p>
                                <h5 class="u-text u-text-3">{{ $item->name }}</h5>
                                <h5 class="u-custom-font u-text u-text-font u-text-4">{{ $item->designation }}</h5>
                            </div>
                        </div>
                    @endforeach
                </div>
    ...
    <section class="u-align-center u-clearfix u-grey-10 u-section-9" id="sec-fa80">
        <img class="u-expanded-width u-image u-image-default u-image-1" src="images/ffdf-min-25.jpg" alt=""
            data-image-width="1920" data-image-height="911">
        <div class="u-align-center u-container-style u-group u-shape-rectangle u-white u-group-1">
            <div class="u-container-layout u-valign-top u-container-layout-1" id="letscomehere">
                <h2 class="u-custom-font u-font-oswald u-text u-text-default u-text-palette-1-base u-text-1"><a
                        href="#">Contact Us</a>
                </h2>
                <div class="u-form u-form-1">
                    <form class="u-clearfix u-form-spacing-20 u-form-vertical u-inner-form" style="padding: 0;"
                        ...
                        <div class="u-form-email u-form-group u-form-partition-factor-3 u-form-group-2">
                            ...
                            <input type="email" placeholder="Enter a valid email address" id="email-d70e"
                                name="email" class="u-grey-10 u-input u-input-rectangle" required="">
                        </div>
                        <div class="u-form-group u-form-partition-factor-3 u-form-phone u-form-group-3">
                            ...
                            <input type="tel"
                                ...
                                placeholder="Telephone Number" id="phone-d5b3" name="phone"
                                class="u-grey-10 u-input u-input-rectangle" required="">
                        </div>
                        ...
                        <input type="hidden" name="formServices" value="e0bb69b0a8aa18554c02c309d5711b63">
                    </form>
                </div>
            </div>
        </div>
    ...
    {{-- <section class="u-backlink u-clearfix u-grey-80">
        ...
        <p class="u-text">
            <span>created with class="u-link" href="" target="_blank">
...
<script>
    function submitForm() {
        ...
        $name = $('#name-d70e').val();
        $phone = $('#phone-d5b3').val();
        $message = $('#message-d70e').val();
        $email = $('#email-d70e').val();
        formData.append('name', $name);
        formData.append('phone', $phone);
        formData.append('email', $email);
        formData.append('message', $message);
        console.log($message, $email, $name, $phone);
        $.ajax({
            type: "post",
            url: "/user-contact",
